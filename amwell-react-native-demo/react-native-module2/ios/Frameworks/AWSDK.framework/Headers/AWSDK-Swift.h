...
SWIFT_CLASS("_TtC5AWSDK20AWSDKUtilityInternal")
@interface AWSDKUtilityInternal : NSObject
+ (void)getDNSLookupTimeFor:(NSURL * _Nonnull)url completion:(SWIFT_NOESCAPE void (^ _Nonnull)(NSTimeInterval, NSError * _Nullable))completion;
